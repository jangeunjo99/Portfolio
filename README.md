...
> 한 번의 개발로 끝이 아닌 ***끊임없는 리팩토링을 통한 개선***과 성과에 성취감을 느낍니다.

> 그래프, 시퀀스, 이미지 데이터 분석의 경험을 토대로, ***다양한 형태의 데이터***를 다룰 수 있습니다.

> 통계학 지식을 바탕으로 분석 결과에 ***논리적이고 체계적인 접근***을 취할 수 있습니다.    
...
|기간|경험|설명|
|---|----|---|
|2023.03-2024.06|프로그래밍개론 실습조교|- C언어 실습|
|2023.03-06, 2024.03-06|웹시스템설계 실습조교|- HTML, CSS, JavaScript 실습 |  
|2023.03-2023.06|데이터마이닝 실습조교|- 데이터 분석 과제 및 머신러닝 수업 Q&A|
|2022.08-2022.10|데이터크리에이어캠프 멘토|- 한국지능정보사회진흥원 <br/> - AI 프로젝트 멘토|  
|2023.07-12|AI지니어스 멘토|- LG CNS <br/> - 청소년 대상 교육 프로그램 멘토|  
|2022.03-2022.08|숙명여자대학교 데이터지능연구실 학부 인턴|- Graph Neural Network (GNN) 연구|  
